...
const ShimmerCodeBlock = () => {
  return (
    <>
      <div className="bg-white rounded-lg p-8 shadow-md mb-4 border-gray-200  overflow-hidden">
        <div className="h-full">
          <div className="p-2">
            ...
            <p className="leading-relaxed mb-3 w-1/2 h-3 animate-pulse bg-gray-200" />
